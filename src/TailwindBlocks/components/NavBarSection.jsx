      ...
      <header className="body-font bg-BgColor text-TextColor">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
            <a className="mr-5 hover:text-TextColor" onClick={() => scrollToSection('hero')}>
              Hero Section
            </a>
            <a className="mr-5 hover:text-TextColor" onClick={() => scrollToSection('content')}>
              Content Section
            </a>
            <a className="mr-5 hover:text-TextColor" onClick={() => scrollToSection('gallery')}>
              Gallery Section
            </a>
            <a className="mr-5 hover:text-TextColor" onClick={() => scrollToSection('team')}>
              Team Section
            </a>
            <a className="mr-5 hover:text-TextColor" onClick={() => scrollToSection('contact')}>
              Contact Section
            </a>
          </nav>
          <button
